...
public class Reg_Teacher extends AppCompatActivity {

    Button Reg, Back;
    EditText t1, t2, t3, t4, t5, t6, t7;
    String Login, Pass, Name, Surname, Email, Tel, Spets;
        ...
        Reg.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Tel = t6.getText().toString();
                        Spets = t7.getText().toString();
                    }
                }
        );
        Back.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        {
                            try {
                                Intent intent = new Intent(Reg_Teacher.this, ForMaster.class);
